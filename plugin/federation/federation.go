...
import (
	...
	"github.com/animeshon/gqlgen/codegen"
	...
	builtins := config.TypeMap{
		"_Service": {
			Model: config.StringList{
				"github.com/animeshon/gqlgen/plugin/federation/fedruntime.Service",
			},
		},
		"_Entity": {
			Model: config.StringList{
				"github.com/animeshon/gqlgen/plugin/federation/fedruntime.Entity",
			},
		},
		"Entity": {
			Model: config.StringList{
		...
		"_Any": {
			Model: config.StringList{"github.com/animeshon/gqlgen/graphql.Map"},
		},
	}
